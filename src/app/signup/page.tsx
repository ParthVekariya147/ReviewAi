...
export const metadata: Metadata = {
  title: "Start Free — Reevo",
  description: "Create your free Reevo account and start collecting authentic Google reviews in minutes.",
};
      ...
      <div style={{
        ...
        <div style={{ position: "relative" }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 12, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", padding: "6px 12px", borderRadius: 999, color: "white" }}>
            <span style={{ width: 6, height: 6, borderRadius: 999, background: "#34D399", boxShadow: "0 0 0 4px rgba(52,211,153,0.3)" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 40 }}>
            {[
              { stat: "8.4M+", label: "QR scans processed" },
              { stat: "1.24M+", label: "Google reviews generated" },
              { stat: "52s", label: "Average completion time" },
            ].map((s) => (
              <div key={s.label} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                <span style={{ fontSize: 18, fontWeight: 700, color: "white", letterSpacing: "-0.02em", minWidth: 64 }}>{s.stat}</span>
